...
$(function() {
    ...
    var data4_errors = [0.1, 0.4, 0.2];
        ...
        var data = [
            {color: "#007bff", points: data1_points, data: data1, label: "داده1"},
            {color: "#ff5a75",  points: data2_points, data: data2, label: "داده2"},
            {color: "#4466f2", lines: {show: true}, points: data3_points, data: data3, label: "داده3"},
            {color: "#1ea6ec", bars: {show: true, align: "center", barWidth: 0.25}, data: data4, label: "داده4"},
