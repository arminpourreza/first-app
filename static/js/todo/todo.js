! function(e) {
    e(document).ready(function() {
        ...
        e(".add-task-btn").click(function() {
            ...
            e(this).attr("title", l), s.hasClass("completed") ? a(t, "به عنوان نامشخص مشخص شده است.") : a(t, " مشخص شده به عنوان کامل.", "success"), s.toggleClass("completed")
            ...
            e("#todo-list .task").addClass("completed"), e("#mark-all-incomplete").removeClass("move-down"), e(this).addClass("move-up"), a("All tasks", "مشخص شده به عنوان کامل.", "success")
        }), e("#mark-all-incomplete").click(function() {
            e("#todo-list .task").removeClass("completed"), e(this).addClass("move-down"), e("#mark-all-finished").removeClass("move-up"), a("All tasks", "به عنوان نامشخص مشخص شده است.")
        })
    })
}(jQuery);