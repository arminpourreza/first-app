    ...
    a.fn.gridEditor = function(b) {
        ...
        return c.each(function(c, d) {
            function e() {
                ...
                var c = a('<div class="dropdown float-left float-xl-right ge-layout-mode"><button type="button" class="btn-screen dropdown-toggle" data-toggle="dropdown"><span>دسکتاپ</span></button><ul class="dropdown-menu" role="menu"><li><a data-width="auto" title="Desktop" class="dropdown-item"><span>دسکتاپ</span></a></li><li><a title="Tablet" class="dropdown-item"><span>تبلت</span></li><li><a title="Phone" class="dropdown-item"><span>تلفن</span></a></li></ul></div>').on("click", "a", function() {
                        var b = a(this);
                    ...
                    h = a('<button title="Edit Source Code" type="button" class="btn-code gm-edit-mode"><span class="fa fa-chevron-right"></span><span class="fa fa-chevron-left"></span></button>').on("click", function() {
